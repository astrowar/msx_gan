...
RawFiles = [
	// { segment: 3, file:"data/g_conv1_w4_0.bin"},
    // { segment: 4, file:"data/g_conv1_w4_1.bin"},
    // { segment: 5, file:"data/g_conv1_w4_2.bin"},
	// { segment: 6, file:"data/g_conv2_w4_0.bin" },
    // { segment: 7, file:"data/g_conv2_w4_1.bin" },
	// { segment: 8, file:"data/g_conv3_w4.bin" },
	// { segment: 9, file:"data/g_tanh_u8_lut.bin" }
];
